...
var known = []struct {
	...
	{Verb: "queue", Aliases: []string{"waiting"}, What: "messages in line, not yet answered"},
	{Verb: "interrupt", Takes: "<run>", What: "ask a run to stop, or take a waiting one out of line"},
